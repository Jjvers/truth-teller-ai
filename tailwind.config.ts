  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        verdict: {
          fact: "hsl(var(--verdict-fact))",
          "fact-foreground": "hsl(var(--verdict-fact-foreground))",
          hoax: "hsl(var(--verdict-hoax))",
          "hoax-foreground": "hsl(var(--verdict-hoax-foreground))",
          mixed: "hsl(var(--verdict-mixed))",
          "mixed-foreground": "hsl(var(--verdict-mixed-foreground))",
          unverified: "hsl(var(--verdict-unverified))",
          "unverified-foreground": "hsl(var(--verdict-unverified-foreground))",
        },
        bias: {
